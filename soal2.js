const fs = require("fs");
const dataPayload = `03/22 08:54:24 INFO   :......rsvp_flow_stateMachine: state RESVED, event T1OUT
...
fs.writeFile("logging.txt", dataPayload, (err, data) => {
  if (err) {
    console.error(err);
  }
  console.log("Data sucessfully writted");
});
